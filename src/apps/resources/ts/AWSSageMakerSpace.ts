...
type Properties = {
  SpaceArn?: StringProperty
  DomainId: StringProperty
  SpaceName: StringProperty
  SpaceSettings?: {
    ...
    SpaceManagedResources?: (string | "ENABLED" | "DISABLED")
    RemoteAccess?: (string | "ENABLED" | "DISABLED")
    AppType?: (string | "JupyterServer" | "KernelGateway" | "TensorBoard" | "RStudioServerPro" | "RSessionGateway" | "JupyterLab" | "CodeEditor")
    CustomFileSystems?: {
      EFSFileSystem?: {
  ...
  OwnershipSettings?: {
    OwnerUserProfileName: StringProperty
  }
  SpaceSharingSettings?: {
    SharingType: (string | "Private" | "Shared")
  }
  SpaceDisplayName?: StringProperty
  Url?: StringProperty
}

export const AWSSageMakerSpace = ({
                                    ResourceName,
                                    DependsOn,
                                    Properties,
                                  }: {
